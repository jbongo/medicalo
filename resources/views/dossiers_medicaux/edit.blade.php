                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                               <input type="text" class="form-control {{$errors->has('nom') ? 'is-invalid' : ''}}" value="{{$utilisateur->nom}}" id="nom" name="nom" placeholder="Nom.." required>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                               <input type="text"  class="form-control {{ $errors->has('prenom') ? ' is-invalid' : '' }}" value="{{$utilisateur->prenom}}" id="prenom" name="prenom" placeholder="Prénom.." required>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                               <input type="text" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" id="val-email" value="{{ $utilisateur->email }}" name="email" placeholder="Email.." required>
                               @if ($errors->has('email'))
                               <br>
                               <div class="alert alert-warning ">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                               <input type="text" class="form-control {{ $errors->has('adresse') ? ' is-invalid' : '' }}" value="{{ $utilisateur->adresse }}" id="adresse" name="adresse" placeholder="N° et Rue.." >
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                               <input type="text" class="form-control {{ $errors->has('secteur') ? ' is-invalid' : '' }}" value="{{ $utilisateur->secteur }}" id="secteur" name="secteur" placeholder="Ex: Marcory" >
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                               <input type="text" class="form-control {{ $errors->has('ville') ? ' is-invalid' : '' }}" value="{{ $utilisateur->ville }}" id="ville" name="ville" placeholder="EX: Paris.." >
                               @if ($errors->has('ville'))
                               <br>
                               <div class="alert alert-warning ">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                               <input type="text" class="form-control {{ $errors->has('telephone1') ? ' is-invalid' : '' }}" value="{{ $utilisateur->telephone1 }}" id="telephone1" name="telephone1" placeholder="Ex: 0600000000.." >
                         ...
                         <div class="form-group row">
                           ...
                           <div class="col-lg-8 col-md-8 col-sm-8">
                              <input type="text" class="form-control {{ $errors->has('telephone2') ? ' is-invalid' : '' }}" value="{{ $utilisateur->telephone2 }}" id="telephone2" name="telephone2" placeholder="Ex: 0600000000.." >
